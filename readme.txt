...
= 3.0 (01-05-22)
* [NEW] Add automatic click tracking option
* [FIX] Fix admin compatibility warnings

= 2.9.5 (12-23-20)
* [UPDATE] Add support to the "woopra_identify" action

= 2.9.4 (08-12-20)
* [FIX] Fix warning when WooCommerce actions are not all selected
